    ...
    <div class="section-body">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('tapel.cari') }}" method="GET">
                    <div class="d-flex bd-highlight mb-3 align-items-center">
                        <div class="p-2 bd-highlight">
                            <input type="text" class="babeng babeng-select  ml-0" placeholder="Cari . . ."  name="cari">
                        </div>
                        <div class="p-2 bd-highlight">
                            <span>
                        ...
                        <div class="ml-auto p-2 bd-highlight">
                            <x-button-create link="{{route('tapel.create')}}"></x-button-create>
                        </div>
                    </div>
                </form>

                <x-jsmultidel link="{{route('tapel.multidel')}}" />
            ...
            <div class="ml-3">{{ $datas->links() }}</div>
        </div>
    </div>
</section>
